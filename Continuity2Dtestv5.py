...
#Checking multiple connections in 2D
...
for i in range(0,length):
    if i ==  0:
        ...
        y = False
        continuity.append(x)
        connected_to_previous_input.append(y)
    else:
...
data = {'connected_to_previous': continuity, 'same_input_as_previous': connected_to_previous_input}
testv5df = pd.DataFrame(data)

#print(df['connected_to_previous'] ==  testv5df['connected_to_previous'])
print(df['same_input_as_previous'] ==  testv5df['same_input_as_previous'])
